	...
	//You can also use querySelector to get the element either with Id or Class name...
	//or below statement query Selector can be used as...document.querySelector("ctx").onmousemove = function()....
